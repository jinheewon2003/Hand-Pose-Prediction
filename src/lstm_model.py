...
# # Scale data by s.t. MSE is more accurate
# Scale features (X)
...
# First 80% Train, Last 20% Test (ie all of r2 is train, 60% of r3 is train, 40% of r3 is test)
#########
...
# Compute the mean squared error along axis 2 (grouped by points)
mse_per_point = np.mean(np.square(difference_reshaped), axis=2)

# Compute the average MSE across the 86 data samples
...
video_file = 'predicted_80split_animation.mp4'  # Provide the file name with extension (e.g., 'animation.mp4')
